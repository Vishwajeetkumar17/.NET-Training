...
namespace StudentPortalDb.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentId,CourseId,EnrollDate,PaymentStatus,PaidAmount")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EnrollmentId,StudentId,CourseId,EnrollDate,PaymentStatus,PaidAmount")] Enrollment enrollment)
        {
